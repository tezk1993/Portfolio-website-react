...
export const ProjectCard = ({ project, projects }) => {
  ...
  return (
    <motion.div
      ...
      style={
        project.title === null ? { display: "none" } : { display: "block" }
      }
    >
      <Link
        key={project.title}
        ...
        state={{ routedProject: project, projects }}
        onAuxClick={() => {
      ...
      <div className={styles.imgcontainer}>
        <img
          loading="lazy"
          src={getImageUrl(project.imgdir + project.cardimg)}
          alt={`Image of project ${project.title}`}
          style={
            project.cardimg === "" ? { display: "none" } : { display: "block" }
          }
        />
